        ...
        <div class="col-md-8">
          <div class="box">
            ...
            <div class="box-body pad">
               @if(isset($re->name))<h1>{!! (html_entity_decode($re->name)) !!}</h1>
                  <br>
                     @endif         
                <p>
                     @if(isset($re->description))<p class="card-text" >{!! (html_entity_decode($re->description)) !!}</p>
                  <br>
                     @endif                  
                  </p>
            </div>
          ...
          <div class="box">
            ...
            <div class="box-body pad">
             <form method="post" action="{{route('comment')}}">
                        ...
                        <input id="" type="hidden" name="id" value="{{ $re->id}}">
